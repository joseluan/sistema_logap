 ...
 */
package br.com.logap.sistema.filter;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		String URLpublica = "/publico/";
		String URLautenticada = "/autenticado/";
		...
		if (reqUrl.contains("/publico/") || reqUrl.equals("/") || reqUrl.contains(".faces.")) {
			permitido = true;
		}
